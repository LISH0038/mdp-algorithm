...
//        }
    ...
    private boolean findPathAndMove(Grid grid, Robot robot, int x, int y, boolean realRun) {
...
//                        robot.sense(realRun);
    ...
    private int moveAndSense(Grid grid, Robot robot, boolean realRun, int calibrationCounter) {
